...
static long dprintf_Pass1(char *format, va_stack_t * vto, char **endpos, va_list arglist)
{
    char *fmt = format;
    int param_num = 0;
    long this_param;
...
#    endif
    ...
    ptr =
        curl_maprintf("test this then baby %s%s%s%s%s%s %d %d %d loser baby get a hit in yer face now!", "", "pretty long string pretty long string pretty long string pretty long string pretty long string", "/", "/", "/", "pretty long string", 1998,
                      1999, 2001);
