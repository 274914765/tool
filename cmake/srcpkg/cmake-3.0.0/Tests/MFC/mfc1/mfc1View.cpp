...
IMPLEMENT_DYNCREATE(Cmfc1View, CView) BEGIN_MESSAGE_MAP(Cmfc1View, CView)
...
#ifdef _DEBUG
void Cmfc1View::AssertValid() const const
{
    CView::AssertValid();
}

void Cmfc1View::Dump(CDumpContext & dc) const const
{
    CView::Dump(dc);
}

Cmfc1Doc *Cmfc1View::GetDocument() const const    // non-debug version is inline
{
