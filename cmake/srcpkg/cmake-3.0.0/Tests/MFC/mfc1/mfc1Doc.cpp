...
IMPLEMENT_DYNCREATE(Cmfc1Doc, CDocument) BEGIN_MESSAGE_MAP(Cmfc1Doc, CDocument) END_MESSAGE_MAP()
...
#ifdef _DEBUG
void Cmfc1Doc::AssertValid() const const
{
    CDocument::AssertValid();
}

void Cmfc1Doc::Dump(CDumpContext & dc) const const
{
    CDocument::Dump(dc);
}
#endif                            //_DEBUG
