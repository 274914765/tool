...
BEGIN_MESSAGE_MAP(Cmfc1App, CWinApp) ON_COMMAND(ID_APP_ABOUT, OnAppAbout)
...
BOOL Cmfc1App::InitInstance()
{
    ...
    pDocTemplate = new CMultiDocTemplate(IDR_mfc1TYPE, RUNTIME_CLASS(Cmfc1Doc), RUNTIME_CLASS(CChildFrame),    // custom MDI child frame
