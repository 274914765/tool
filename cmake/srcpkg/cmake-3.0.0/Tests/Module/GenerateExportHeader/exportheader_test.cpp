...
#define STRINGIFY(A) STRINGIFY_IMPL(A)
    ...
    compare(STRINGIFY(SRC_DIR) "/libshared_export.h", STRINGIFY(BIN_DIR) "/libshared/libshared_export.h");
    compare(STRINGIFY(SRC_DIR) "/libstatic_export.h", STRINGIFY(BIN_DIR) "/libstatic/libstatic_export.h");
