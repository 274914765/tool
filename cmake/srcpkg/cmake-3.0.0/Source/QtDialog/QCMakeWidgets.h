...
Q_OBJECT public:
    ...
    protected slots:virtual void chooseFile() = 0;
      signals: void fileDialogExists(bool);
protected:
...
{
    Q_OBJECT Q_PROPERTY(QString value READ currentText WRITE setValue USER true);
public:
