...
//----------------------------------------------------------------------------
void cmCTestGlobalVC::DoRevision(Revision const &revision, std::vector < Change > const &changes)
{
    ...
    for (std::vector < Change >::const_iterator ci = changes.begin(); ci != changes.end(); ++ci)
    {
...
//----------------------------------------------------------------------------
void cmCTestGlobalVC::DoModification(PathStatus status, std::string const &path)
{
...
//----------------------------------------------------------------------------
void cmCTestGlobalVC::WriteXMLDirectory(std::ostream & xml, std::string const &path, Directory const &dir)
{
