...
private:
   ...
   */
    ...
    bool ProcessMemCheckBoundsCheckerOutput(const std::string & str, std::string & log, int *results);
    ...
    void appendMemTesterOutput(cmCTestTestHandler::cmCTestTestResult & res, int test);
