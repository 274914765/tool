...
bool cmProcess::StartProcess()
{
    ...
    return (cmsysProcess_GetState(this->Process) == cmsysProcess_State_Executing);
}
...
int cmProcess::ReportStatus()
{
    ...
    switch (cmsysProcess_GetState(this->Process))
    {
        case cmsysProcess_State_Starting:
            {
                std::cerr << "cmProcess: Never started " << this->Command << " process.\n";
            }
            break;
        case cmsysProcess_State_Error:
            {
                std::cerr << "cmProcess: Error executing " << this->Command << " process: " << cmsysProcess_GetErrorString(this->Process) << "\n";
            }
            break;
        case cmsysProcess_State_Exception:
            {
                std::cerr << "cmProcess: " << this->Command << " process exited with an exception: ";
        ...
        case cmsysProcess_State_Exited:
            {
                ...
                std::cerr << "cmProcess: " << this->Command << " process exited with code " << result << "\n";
            }
            break;
