...
{
    cmCTestTestHandler::cmCTestTestProperties * properties = this->Properties[test];
...
void cmCTestBatchTestHandler::WriteTestCommand(int test, std::fstream & fout)
{
    ...
    for (std::vector < std::string >::iterator arg = processArgs.begin(); arg != processArgs.end(); ++arg)
    {
        fout << *arg << " ";
    }
