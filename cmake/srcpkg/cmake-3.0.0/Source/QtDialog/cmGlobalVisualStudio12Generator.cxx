...
public:
    virtual cmGlobalGenerator * CreateGlobalGenerator(const char *name) const
    {
        ...
        if (strcmp(p, "") == 0)
        {
            return new cmGlobalVisualStudio12Generator(name, NULL, NULL);
        }
        if (strcmp(p, " Win64") == 0)
        {
            return new cmGlobalVisualStudio12Generator(name, "x64", "CMAKE_FORCE_WIN64");
        }
        if (strcmp(p, " ARM") == 0)
        {
            return new cmGlobalVisualStudio12Generator(name, "ARM", NULL);
        }
        return 0;
    }
...
//----------------------------------------------------------------------------
cmGlobalVisualStudio12Generator::cmGlobalVisualStudio12Generator(const char *name, const char *platformName, const char *additionalPlatformDefinition):cmGlobalVisualStudio11Generator(name, platformName, additionalPlatformDefinition)
{
    std::string vc12Express;
    this->ExpressEdition = cmSystemTools::ReadRegistryValue("HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\VCExpress\\12.0\\Setup\\VC;" "ProductDir", vc12Express, cmSystemTools::KeyWOW64_32);
    this->PlatformToolset = "v120";
}

//----------------------------------------------------------------------------
bool cmGlobalVisualStudio12Generator::MatchesGeneratorName(const char *name) const
{
    std::string genName;
...
{
    cmLocalVisualStudio10Generator *lg = new cmLocalVisualStudio10Generator(cmLocalVisualStudioGenerator::VS12);
