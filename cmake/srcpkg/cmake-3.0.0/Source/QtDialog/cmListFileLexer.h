...
#    endif
    ...
    int cmListFileLexer_SetFileName(cmListFileLexer *, const char *, cmListFileLexer_BOM * bom);
    ...
    const char *cmListFileLexer_GetTypeAsString(cmListFileLexer *, cmListFileLexer_Type);
