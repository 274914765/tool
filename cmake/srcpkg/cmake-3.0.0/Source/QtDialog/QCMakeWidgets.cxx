...
QCMakeFileEditor::QCMakeFileEditor(QWidget * p, const QString & var):QLineEdit(p), Variable(var)
{
...
QCMakeFilePathEditor::QCMakeFilePathEditor(QWidget * p, const QString & var):QCMakeFileEditor(p, var)
{
    this->setCompleter(new QCMakeFileCompleter(this, false));
}

QCMakePathEditor::QCMakePathEditor(QWidget * p, const QString & var):QCMakeFileEditor(p, var)
{
...
QCMakeFileCompleter::QCMakeFileCompleter(QObject * o, bool dirs):QCompleter(o)
{
