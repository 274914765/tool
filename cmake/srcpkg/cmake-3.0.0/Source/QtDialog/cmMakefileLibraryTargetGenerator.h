...
protected:
    ...
    void WriteLibraryRules(const char *linkRule, const char *extraFlags, bool relink);
    ...
    void AppendOSXVerFlag(std::string & flags, const char *lang, const char *name, bool so);
};
