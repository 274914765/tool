...
{
public:
    cmOSXBundleGenerator(cmGeneratorTarget * target, const char *configName);
    ...
    void GenerateMacOSXContentStatements(std::vector < cmSourceFile * >const &sources, MacOSXContentGeneratorType * generator);
