...
//----------------------------------------------------------------------------
cmSourceGroup::cmSourceGroup(const char *name, const char *regex, const char *parentName):Name(name)
{
...
cmSourceGroup *cmSourceGroup::LookupChild(const char *name) const
{
    ...
    std::vector < cmSourceGroup >::const_iterator iter = this->Internal->GroupChildren.begin();
    const std::vector < cmSourceGroup >::const_iterator end = this->Internal->GroupChildren.end();
...
{
    // initializing iterators
    std::vector < cmSourceGroup >::iterator iter = this->Internal->GroupChildren.begin();
    std::vector < cmSourceGroup >::iterator end = this->Internal->GroupChildren.end();
