...
public:
  ...
  /** \brief Describes the working modes of cmake */
    ...
    static const char *GetCMakeFilesDirectory()
    {
        return "/CMakeFiles";
    };
   ...
   */
    ...
    void AddCacheEntry(const char *key, const char *value, const char *helpString, int type);
  ...
  /** Get list of all commands */
    RegisteredCommandsMap *GetCommands()
    {
  ...
  /** Check if a command exists. */
    ...
    bool GetIsInTryCompile()
    {
        return this->InTryCompile;
    }

    ///! Is this cmake running as a result of a TRY_COMPILE command
    void SetIsInTryCompile(bool i)
    {
        this->InTryCompile = i;
    }
   ...
   */
    ...
    cmVariableWatch *GetVariableWatch()
    {
        return this->VariableWatch;
    }
    ...
    bool GetDebugTryCompile()
    {
        return this->DebugTryCompile;
    }
    void DebugTryCompileOn()
    {
   ...
   */
    ...
    bool GetWarnUninitialized()
    {
        return this->WarnUninitialized;
    }
    void SetWarnUninitialized(bool b)
    {
        this->WarnUninitialized = b;
    }
    bool GetWarnUnused()
    {
        return this->WarnUnused;
    }
    void SetWarnUnused(bool b)
    {
        this->WarnUnused = b;
    }
    bool GetWarnUnusedCli()
    {
        return this->WarnUnusedCli;
    }
    void SetWarnUnusedCli(bool b)
    {
        this->WarnUnusedCli = b;
    }
    bool GetCheckSystemVars()
    {
        return this->CheckSystemVars;
    }
    void SetCheckSystemVars(bool b)
    {
        this->CheckSystemVars = b;
    }

    void MarkCliAsUsed(const std::string & variable);

    // Define a property
    void DefineProperty(const char *name, cmProperty::ScopeType scope, const char *ShortDescription, const char *FullDescription, bool chain = false);
  ...
  /** Display a message to the user.  */
    void IssueMessage(cmake::MessageType t, std::string const &text, cmListFileBacktrace const &backtrace);
    ///! run the --build option
    int Build(const std::string & dir, const std::string & target, const std::string & config, const std::vector < std::string > &nativeOptions, bool clean);
...
protected:
    ...
    typedef cmExternalMakefileProjectGenerator *(*CreateExtraGeneratorFunctionType) ();
    typedef std::map < cmStdString, CreateExtraGeneratorFunctionType > RegisteredExtraGeneratorsMap;
