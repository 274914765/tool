   ...
   */
    ...
    struct map_to_ninja_path
    {
        cmLocalNinjaGenerator *LocalGenerator;
          map_to_ninja_path(cmLocalNinjaGenerator * LocalGen):LocalGenerator(LocalGen)
        {
        }
...
private:
    ...
    void WriteCustomCommandBuildStatement(cmCustomCommand const *cc, const cmNinjaDeps & orderOnlyDeps);
    ...
    typedef std::map < cmCustomCommand const *, std::set < cmTarget * >> CustomCommandTargetMap;
