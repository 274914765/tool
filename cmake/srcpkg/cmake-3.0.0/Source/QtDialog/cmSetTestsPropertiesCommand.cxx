...
bool cmSetTestsPropertiesCommand::InitialPass(std::vector < std::string > const &args, cmExecutionStatus &)
{
    if (args.size() < 1)
    {
    ...
    {
        std::string errors;
        bool ret = cmSetTestsPropertiesCommand::SetOneTest(args[i].c_str(),
                                                           propertyPairs,
...
bool cmSetTestsPropertiesCommand::SetOneTest(const char *tname, std::vector < std::string > &propertyPairs, cmMakefile * mf, std::string & errors)
{
