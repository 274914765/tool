...
StartCompilerSetup::StartCompilerSetup(QWidget * p):QWizardPage(p)
{
    ...
    QObject::connect(this->CompilerSetupOptions[0], SIGNAL(toggled(bool)), this, SLOT(onSelectionChanged(bool)));
    QObject::connect(this->CompilerSetupOptions[1], SIGNAL(toggled(bool)), this, SLOT(onSelectionChanged(bool)));
    QObject::connect(this->CompilerSetupOptions[2], SIGNAL(toggled(bool)), this, SLOT(onSelectionChanged(bool)));
    QObject::connect(this->CompilerSetupOptions[3], SIGNAL(toggled(bool)), this, SLOT(onSelectionChanged(bool)));
}
...
NativeCompilerSetup::NativeCompilerSetup(QWidget * p):QWizardPage(p)
{
    QVBoxLayout *l = new QVBoxLayout(this);
...
CrossCompilerSetup::CrossCompilerSetup(QWidget * p):QWizardPage(p)
{
    this->setupUi(this);
...
ToolchainCompilerSetup::ToolchainCompilerSetup(QWidget * p):QWizardPage(p)
{
    QVBoxLayout *l = new QVBoxLayout(this);
...
FirstConfigure::FirstConfigure()
{
    ...
    QObject::connect(this->mStartCompilerSetupPage, SIGNAL(selectionChanged()), this, SLOT(restart()));
