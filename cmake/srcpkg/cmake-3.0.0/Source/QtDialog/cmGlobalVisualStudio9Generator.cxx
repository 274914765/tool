...
public:
    virtual cmGlobalGenerator * CreateGlobalGenerator(const char *name) const
    {
        ...
        if (p[0] == '\0')
        {
            return new cmGlobalVisualStudio9Generator(name, NULL, NULL);
        }
        ...
        if (!strcmp(p, "IA64"))
        {
            return new cmGlobalVisualStudio9Generator(name, "Itanium", "CMAKE_FORCE_IA64");
        }

        if (!strcmp(p, "Win64"))
        {
            return new cmGlobalVisualStudio9Generator(name, "x64", "CMAKE_FORCE_WIN64");
        }
        ...
        cmGlobalVisualStudio9Generator *ret = new cmGlobalVisualStudio9Generator(name, p, NULL);
...
//----------------------------------------------------------------------------
cmGlobalVisualStudio9Generator::cmGlobalVisualStudio9Generator(const char *name, const char *platformName, const char *additionalPlatformDefinition):cmGlobalVisualStudio8Generator(name, platformName, additionalPlatformDefinition)
{
}
...
{
    cmLocalVisualStudio7Generator *lg = new cmLocalVisualStudio7Generator(cmLocalVisualStudioGenerator::VS9);
...
//----------------------------------------------------------------------------
void cmGlobalVisualStudio9Generator::EnableLanguage(std::vector < std::string > const &lang, cmMakefile * mf, bool optional)
{
...
std::string cmGlobalVisualStudio9Generator::GetUserMacrosDirectory()
{
    ...
    if (cmSystemTools::ReadRegistryValue("HKEY_CURRENT_USER\\Software\\Microsoft\\VisualStudio\\9.0;" "VisualStudioProjectsLocation", base))
    {
