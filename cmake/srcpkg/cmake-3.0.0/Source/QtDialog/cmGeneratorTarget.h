...
public:
  ...
  /** Full path with trailing slash to the top-level directory
    ...
    void GetAppleArchs(const char *config, std::vector < std::string > &archVec) const;
...
typedef std::map < cmTarget const *, cmGeneratorTarget *, cmStrictTargetComparison > cmGeneratorTargetsType;
