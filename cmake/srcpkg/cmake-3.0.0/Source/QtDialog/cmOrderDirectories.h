...
{
public:
    cmOrderDirectories(cmGlobalGenerator * gg, cmTarget const *target, const char *purpose);
     ~cmOrderDirectories();
    ...
    void SetLinkExtensionInfo(std::vector < std::string > const &linkExtensions, std::string const &removeExtRegex);
