...
protected:
    ...
    bool HandleCMakePathCommand(std::vector < std::string > const &args, bool nativePath);
...
private:
    void AddEvaluationFile(const std::string & inputName, const std::string & outputExpr, const std::string & condition, bool inputIsContent);
};
