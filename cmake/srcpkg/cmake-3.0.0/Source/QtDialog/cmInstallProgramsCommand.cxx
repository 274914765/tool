...
// cmExecutableCommand
bool cmInstallProgramsCommand::InitialPass(std::vector < std::string > const &args, cmExecutionStatus &)
{
    if (args.size() < 2)
    {
...
void cmInstallProgramsCommand::FinalPass()
{
    ...
    else                        // reg exp list
    {
        ...
        cmSystemTools::Glob(this->Makefile->GetCurrentDirectory(), this->FinalArgs[0].c_str(), programs);
    ...
    this->Makefile->AddInstallGenerator(new cmInstallFilesGenerator(this->Makefile, this->Files, destination.c_str(), true, no_permissions, no_configurations, no_component.c_str(), no_rename));
}
