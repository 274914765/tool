...
{
public:
    cmCommandArgument(cmCommandArgumentsHelper * args, const char *key, cmCommandArgumentGroup * group = 0);
...
{
public:
    cmCAStringVector(cmCommandArgumentsHelper * args, const char *key, cmCommandArgumentGroup * group = 0);
...
{
public:
    cmCAString(cmCommandArgumentsHelper * args, const char *key, cmCommandArgumentGroup * group = 0);
...
{
public:
    cmCAEnabler(cmCommandArgumentsHelper * args, const char *key, cmCommandArgumentGroup * group = 0);
...
{
public:
    cmCADisabler(cmCommandArgumentsHelper * args, const char *key, cmCommandArgumentGroup * group = 0);
...
public:
    ...
    void Parse(const std::vector < std::string > *args, std::vector < std::string > *unconsumedArgs);
    /// Add an argument.
