...
namespace KWSYS_NAMESPACE
{
    ...
    Encoding::CommandLineArguments Encoding::CommandLineArguments::Main(int argc, char const *const *argv)
    {
#ifdef _WIN32
        (void) argc;
        (void) argv;
    ...
    Encoding::CommandLineArguments::CommandLineArguments(int ac, char const *const *av)
    {
    ...
    Encoding::CommandLineArguments::CommandLineArguments(int ac, wchar_t const *const *av)
    {
        this->argv_.resize(ac + 1);
        for (int i = 0; i < ac; i++)
        {
    ...
    Encoding::CommandLineArguments::CommandLineArguments(const CommandLineArguments & other)
    {
    ...
    Encoding::CommandLineArguments & Encoding::CommandLineArguments::operator=(const CommandLineArguments & other)
    {
        size_t i;
