...
Q_OBJECT public:
    ...
    public slots:void setBinaryDirectory(const QString & dir);
    void setSourceDirectory(const QString & dir);

    protected slots:void initialize();
    void doConfigure();
    void doGenerate();
...
protected:
    ...
    enum State
    { Interrupting, ReadyConfigure, ReadyGenerate, Configuring, Generating };
