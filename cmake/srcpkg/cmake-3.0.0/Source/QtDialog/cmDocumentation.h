...
public:
   ...
   * help arguments.
   */
    bool CheckOptions(int argc, const char *const *argv, const char *exitOpt = 0);
  ...
  /** Print help of the given type.  */
    ...
    void SetShowGenerators(bool showGen)
    {
        this->ShowGenerators = showGen;
    }
  ...
  /** Set a section of the documentation. Typical sections include Name,
    ...
    void SetSection(const char *sectionName, std::vector < cmDocumentationEntry > &docs);
  ...
  /** Add the documentation to the beginning/end of the section */
    ...
    void PrependSection(const char *sectionName, std::vector < cmDocumentationEntry > &docs);
    ...
    void AppendSection(const char *sectionName, std::vector < cmDocumentationEntry > &docs);
