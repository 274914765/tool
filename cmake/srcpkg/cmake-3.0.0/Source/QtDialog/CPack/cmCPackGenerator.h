...
public:
   ...
   */
    ...
    {
        this->GeneratorVerbose = val ? cmSystemTools::OUTPUT_MERGE : cmSystemTools::OUTPUT_NONE;
    }
...
protected:
   ...
   */
    virtual std::string GetComponentInstallDirNameSuffix(const std::string & componentName);
   ...
   *            false otherwise
   */
    virtual std::string GetComponentPackageFileName(const std::string & initialPackageFileName, const std::string & groupOrComponentName, bool isGroupName);
   ...
   */
    ...
    virtual int InstallProjectViaInstallCommands(bool setDestDir, const char *tempInstallDirectory);
    ...
    virtual int InstallProjectViaInstallCMakeProjects(bool setDestDir, const char *tempInstallDirectory);
