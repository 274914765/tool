...
int main(int argc, char *argv[])
{
    ...
    if (!(scriptFileURL = CFBundleCopyResourceURL(appBundle, fileName, NULL, NULL)))
    {
    ...
    if (CFURLGetFileSystemRepresentation(scriptFileURL, true, path, PATH_MAX) == false)
    {
    ...
    cmsys_stl::string scriptDirectory = cmsys::SystemTools::GetFilenamePath(fullScriptPath);
