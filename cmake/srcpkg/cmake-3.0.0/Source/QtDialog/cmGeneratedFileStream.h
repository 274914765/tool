 ...
 * being updated.
 */
class cmGeneratedFileStream:private cmGeneratedFileStreamBase, public cmsys::ofstream
{
public:
   ...
   */
    cmGeneratedFileStream & Open(const char *name, bool quiet = false, bool binaryFlag = false);
