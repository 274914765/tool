...
public:
    ...
    static int CallMacro(const std::string & slnFile, const std::string & macro, const std::string & args, const bool logErrorsAsMessages);
    ...
    static int GetNumberOfRunningVisualStudioInstances(const std::string & slnFile);
