...
#    include <iostream.h>
#    include <string>
void f(ostream & os, const kwsys_stl::string & s)
{
    os << s;
}
...
#    include <iostream.h>
#    include <string>
void f(istream & is, kwsys_stl::string & s)
{
    is >> s;
}
...
#    include <string>
bool f(const kwsys_stl::string & s)
{
    return s != "";
}
...
#    include <iterator>
#    include <list>
void f(kwsys_stl::list < int >::iterator x)
{
    kwsys_stl::iterator_category(x);
}
...
void f(kwsys_stl::list < int >::iterator x)
{
    kwsys_stl::__iterator_category(x);
}
...
#    include <memory>
template < class Alloc > void f(const Alloc &)
{
...
#    include <memory>
template < class T, class Alloc > void f(const T &, const Alloc &)
{
...
int main()
{
    ...
    char *demangledFunction = abi::__cxa_demangle(function, buffer, &bufferLen, &status);
    return status;
}
#endif
