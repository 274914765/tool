...
static int testCommandLineArguments()
{
    ...
    kwsys::Encoding::CommandLineArguments arg2 = kwsys::Encoding::CommandLineArguments(args);
    ...
    for (int i = 0; i < args.argc(); i++)
    {
        ...
        {
            std::cout << "argv[" << i << "] " << argv[i] << " != " << u8_arg << std::endl;
            status++;
        }
    }

    kwsys::Encoding::CommandLineArguments args3 = kwsys::Encoding::CommandLineArguments::Main(2, argv);
