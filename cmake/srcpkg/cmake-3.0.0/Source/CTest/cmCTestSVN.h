...
private:
    ...
    bool RunSVNCommand(std::vector < char const *>const &parameters, OutputParser * out, OutputParser * err);
    ...
    void DoRevisionSVN(Revision const &revision, std::vector < Change > const &changes);
