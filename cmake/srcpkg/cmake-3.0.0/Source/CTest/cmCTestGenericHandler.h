...
public:
   ...
   */
    ...
    {
        this->HandlerVerbose = val ? cmSystemTools::OUTPUT_MERGE : cmSystemTools::OUTPUT_NONE;
    }
   ...
   */
    virtual int ProcessCommandLineArguments(const std::string & /*currentArg */ , size_t & /*idx */ ,
   ...
   */
    void SetCTestInstance(cmCTest * ctest)
    {
        this->CTest = ctest;
    }
    cmCTest *GetCTestInstance()
    {
        return this->CTest;
    }
   ...
   */
    ...
    void SetAppendXML(bool b)
    {
        this->AppendXML = b;
    }

protected:
    bool StartResultingXML(cmCTest::Part part, const char *name, cmGeneratedFileStream & xofs);
