...
//----------------------------------------------------------------------------
extern "C" int cmBZRXMLParserUnknownEncodingHandler(void *, const XML_Char * name, XML_Encoding * info)
{
    ...
    if (name == std::string("ascii") || name == std::string("cp1252") || name == std::string("ANSI_X3.4-1968"))
    {
...
{
public:
    InfoParser(cmCTestBZR * bzr, const char *prefix):BZR(bzr), CheckOutFound(false)
    {
...
{
public:
    RevnoParser(cmCTestBZR * bzr, const char *prefix, std::string & rev):Rev(rev)
    {
        this->SetLog(&bzr->Log, prefix);
...
//----------------------------------------------------------------------------
class cmCTestBZR::LogParser:public cmCTestVC::OutputLogger, private cmXMLParser
{
public:
    LogParser(cmCTestBZR * bzr, const char *prefix):OutputLogger(bzr->Log, prefix), BZR(bzr), EmailRegex("(.*) <([A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+)>")
    {
...
private:
    ...
    virtual void StartElement(const char *name, const char **)
    {
        ...
        else if (strcmp(name, "modified") == 0 || strcmp(name, "renamed") == 0 || strcmp(name, "kind-changed") == 0)
        {
        ...
        else if (strcmp(name, "unknown") == 0 || strcmp(name, "conflicts") == 0)
        {
    ...
    virtual void EndElement(const char *name)
    {
        ...
        else if ((strcmp(name, "file") == 0 || strcmp(name, "directory") == 0) && !this->CData.empty())
        {
...
private:
    ...
    bool ProcessLine()
    {
        ...
        {
            this->DoPath(this->RegexUpdate.match(1)[0], this->RegexUpdate.match(2)[0], this->RegexUpdate.match(3)[0], this->RegexUpdate.match(4));
        }
        return true;
    }
...
{
    cmCTestLog(this->CTest, HANDLER_OUTPUT, "   Gathering version information (one . per revision):\n" "    " << std::flush);
...
private:
    ...
    bool ProcessLine()
    {
        ...
        {
            this->DoPath(this->RegexStatus.match(1)[0], this->RegexStatus.match(2)[0], this->RegexStatus.match(3)[0], this->RegexStatus.match(4));
        }
        return true;
    }
    ...
    void DoPath(char c0, char c1, char c2, std::string path)
    {
        ...
        if (c0 == '+' || c0 == 'R' || c0 == 'P' || c1 == 'M' || c1 == 'K' || c1 == 'N' || c1 == 'D' || c2 == '*')
        {
