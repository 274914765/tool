...
void cmDocumentationFormatter::PrintFormatted(std::ostream & os, const char *text)
{
    if (!text)
    {
        return;
...
void cmDocumentationFormatter::PrintPreformatted(std::ostream & os, const char *text)
{
    bool newline = true;
...
void cmDocumentationFormatter::PrintParagraph(std::ostream & os, const char *text)
{
    os << this->TextIndent;
...
void cmDocumentationFormatter::PrintSection(std::ostream & os, cmDocumentationSection const &section)
{
    os << section.GetName() << "\n";

    const std::vector < cmDocumentationEntry > &entries = section.GetEntries();
    for (std::vector < cmDocumentationEntry >::const_iterator op = entries.begin(); op != entries.end(); ++op)
    {
        if (op->Name.size())
        {
            os << "  " << op->Name;
