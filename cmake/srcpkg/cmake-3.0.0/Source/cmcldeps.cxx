...
static void replaceAll(std::string & str, const std::string & search, const std::string & repl)
{
...
static void parseCommandLine(LPWSTR wincmdline, std::string & lang, std::string & srcfile, std::string & dfile, std::string & objfile, std::string & prefix, std::string & clpath, std::string & binpath, std::string & rest)
{
...
static void outputDepFile(const std::string & dfile, const std::string & objfile, std::vector < std::string > &incs)
{
...
static int process(const std::string & srcfilename, const std::string & dfile, const std::string & objfile, const std::string & prefix, const std::string & cmd, const std::string & dir = "", bool quiet = false)
{
    std::string output;
...
int main()
{
    ...
    parseCommandLine(GetCommandLineW(), lang, srcfile, dfile, objfile, prefix, cl, binpath, rest);
    ...
    if (lang == "C" || lang == "CXX")
    {
        return process(srcfilename, dfile, objfile, prefix, binpath + nol + show + rest);
    }
    else if (lang == "RC")
    {
