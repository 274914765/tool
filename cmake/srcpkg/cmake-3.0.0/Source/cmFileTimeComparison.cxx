...
public:
    ...
    inline bool TimesDiffer(cmFileTimeComparison_Type * st1, cmFileTimeComparison_Type * st2);
};
...
bool cmFileTimeComparisonInternal::Stat(const char *fname, cmFileTimeComparison_Type * st)
{
    ...
    if (!GetFileAttributesExW(cmsys::Encoding::ToWide(fname).c_str(), GetFileExInfoStandard, &fdata))
    {
        return false;
    }
...
//----------------------------------------------------------------------------
bool cmFileTimeComparisonInternal::TimesDiffer(cmFileTimeComparison_Type * s1, cmFileTimeComparison_Type * s2)
{
#if !defined(_WIN32) || defined(__CYGWIN__)
#    if cmsys_STAT_HAS_ST_MTIM
...
//----------------------------------------------------------------------------
bool cmFileTimeComparisonInternal::FileTimesDiffer(const char *f1, const char *f2)
{
    // Get the modification time for each file.
    cmFileTimeComparison_Type s1;
    cmFileTimeComparison_Type s2;
