...
void cmLocalVisualStudio10Generator::Generate()
{
    ...
    for (cmTargets::iterator l = tgts.begin(); l != tgts.end(); ++l)
    {
        ...
        if (static_cast < cmGlobalVisualStudioGenerator * >(this->GlobalGenerator)->TargetIsFortranOnly(l->second))
        {
            this->CreateSingleVCProj(l->first.c_str(), l->second);
        }
        else
        {
            cmVisualStudio10TargetGenerator tg(&l->second, static_cast < cmGlobalVisualStudio10Generator * >(this->GetGlobalGenerator()));
            tg.Generate();
        }
    }
...
void cmLocalVisualStudio10Generator::ReadAndStoreExternalGUID(const char *name, const char *path)
{
