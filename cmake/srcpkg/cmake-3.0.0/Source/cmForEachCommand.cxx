...
bool cmForEachFunctionBlocker::IsFunctionBlocked(const cmListFileFunction & lff, cmMakefile & mf, cmExecutionStatus & inStatus)
{
...
bool cmForEachFunctionBlocker::ShouldRemove(const cmListFileFunction & lff, cmMakefile & mf)
{
...
bool cmForEachCommand::InitialPass(std::vector < std::string > const &args, cmExecutionStatus &)
{
    if (args.size() < 1)
    {
...
bool cmForEachCommand::HandleInMode(std::vector < std::string > const &args)
{
    ...
    enum Doing
    { DoingNone, DoingLists, DoingItems };
